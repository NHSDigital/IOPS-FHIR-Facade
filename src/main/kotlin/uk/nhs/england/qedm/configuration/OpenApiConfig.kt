...
*/
        ...
        var relatedPerson = PathItem()
            .get(
                Operation()
                    .addTagsItem(ADMINISTRATION)
                    .summary("Read RelatedPerson")
        ...
        oas.path("/FHIR/R4/RelatedPerson/{id}",relatedPerson)

        relatedPerson = PathItem()
            .get(
                Operation()
                    .addTagsItem(ADMINISTRATION)
                    ...
                    .addParametersItem(Parameter()
                        ...
                        .schema(StringSchema())
                        .example("https://fhir.nhs.uk/Id/nhs-number|9449304130")
                    )
                    .addParametersItem(Parameter()
                        ...
                        .description("A patient identifier")
                        .schema(StringSchema())
                        .example("https://fhir.nhs.uk/Id/nhs-number|9459304130")
                    )
                    .addParametersItem(Parameter()
                        .name("_include")
                        .`in`("query")
                        ...
                        .schema(StringSchema())
                        .example("RelatedPerson:patient")
                    )

            )
        oas.path("/FHIR/R4/RelatedPerson",relatedPerson)

        var flagItem = PathItem()
            .get(
                Operation()
                    .addTagsItem(ADMINISTRATION)
                    .summary("Read Flag")
        ...
        oas.path("/FHIR/R4/Flag/{id}",flagItem)
        ...
        oas.path("/FHIR/R4/Flag",flagItem)
            ...
            .get(
                Operation()
                    ...
                    .addParametersItem(Parameter()
                        ...
                        .required(false)
                        .style(Parameter.StyleEnum.SIMPLE)
                        .description("Who/what is the subject of the allergy. `https://fhir.nhs.uk/Id/nhs-number|{nhsNumber}` ")
                        .schema(StringSchema())
                    )
                    .addParametersItem(Parameter()
                        .name("date")
            ...
            .get(
                Operation()
                    ...
                    .addParametersItem(Parameter()
                        ...
                        .required(false)
                        .style(Parameter.StyleEnum.SIMPLE)
                        .description("Who/what is the subject of the condition. `https://fhir.nhs.uk/Id/nhs-number|{nhsNumber}` ")
                        .schema(StringSchema())
                    )
                    .addParametersItem(Parameter()
                        .name("record-date")
            ...
            .get(
                Operation()
                    ...
                    .addParametersItem(Parameter()
                        ...
                        .required(false)
                        .style(Parameter.StyleEnum.SIMPLE)
                        .description("Who/what is the subject of the report. `https://fhir.nhs.uk/Id/nhs-number|{nhsNumber}` ")
                        .schema(StringSchema())
                    )
                    .addParametersItem(Parameter()
                        .name("category")
            ...
            .get(
                Operation()
                    ...
                    .addParametersItem(Parameter()
                        ...
                        .required(false)
                        .style(Parameter.StyleEnum.SIMPLE)
                        .description("Who/what is the subject of the procedure. `https://fhir.nhs.uk/Id/nhs-number|{nhsNumber}` ")
                        .schema(StringSchema())
                    )
                    .addParametersItem(Parameter()
                        .name("date")
            ...
            .get(
                Operation()
                    ...
                    .addParametersItem(Parameter()
                        ...
                        .required(false)
                        .style(Parameter.StyleEnum.SIMPLE)
                        .description("Who/what is the subject of the encounter `https://fhir.nhs.uk/Id/nhs-number|{nhsNumber}` ")
                        .schema(StringSchema())
                    )
                    .addParametersItem(Parameter()
                        .name("date")
            ...
            .get(
                Operation()
                    ...
                    .addParametersItem(Parameter()
                        ...
                        .required(false)
                        .style(Parameter.StyleEnum.SIMPLE)
                        .description("Who/what is the subject of the prescription. `https://fhir.nhs.uk/Id/nhs-number|{nhsNumber}` ")
                        .schema(StringSchema())
                    )
                    .addParametersItem(Parameter()
                        .name("date")
            ...
            .get(
                Operation()
                    ...
                    .addParametersItem(Parameter()
                        ...
                        .required(false)
                        .style(Parameter.StyleEnum.SIMPLE)
                        .description("Who/what is the subject of the medication statement. `https://fhir.nhs.uk/Id/nhs-number|{nhsNumber}` ")
                        .schema(StringSchema())
                    )
            ...
            .get(
                Operation()
                    ...
                    .addParametersItem(Parameter()
                        ...
                        .required(false)
                        .style(Parameter.StyleEnum.SIMPLE)
                        .description("Who/what is the subject of the vaccination. `https://fhir.nhs.uk/Id/nhs-number|{nhsNumber}` ")
                        .schema(StringSchema())
                    )
