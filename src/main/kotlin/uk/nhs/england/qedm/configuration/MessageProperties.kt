...
class MessageProperties {
    private val log = LoggerFactory.getLogger(uk.nhs.england.qedm.configuration.MessageProperties::class.java)
    ...
    fun getProperties(): Properties? {
        if (properties == null) {
            ...
            try {
                uk.nhs.england.qedm.configuration.MessageProperties::class.java.classLoader.getResourceAsStream(HAPI_PROPERTIES).use { `in` ->
    ...
    fun getOrchestrationFhirServer(): String? {
        return getProperty(ORCHESTRATION_FHIR_SERVER)
    }
}
